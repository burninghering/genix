...
`
function DeviceDeleteModal ({onDeleteClick,onDeviceDeleteModalClose}) {
    return (
        <BlackBG>
            <BaseBG>
                <TopContainer>
                    ...
                    <TextContainer>
                        <GuideText>삭제한 디바이스 데이터는 복구가 불가합니다.</GuideText>
                        <GuideText>진행하려면 확인 버튼을 눌러주십시오.</GuideText>
                    </TextContainer>
                </TopContainer>
                <BottomContainer>
                    <OkayBtn onClick = {onDeleteClick}>확인</OkayBtn>
                    <CancelBtn onClick={onDeviceDeleteModalClose}>취소</CancelBtn>
                </BottomContainer>
            </BaseBG>
        </BlackBG>
    )
